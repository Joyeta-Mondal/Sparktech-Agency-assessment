    ...
    <div className="max-w-6xl mx-auto p-4 bg-white">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
        <div className="flex-1">
          <h1 className="text-2xl lg:text-4xl font-black text-gray-900 mb-2">
            El Aurassi Hotel
          </h1>
...
<div className="mb-6">
  <div className="grid grid-cols-6 gap-2">
    {/* Main large image (2/3 width, 2 rows) */}
    ...
    {/* Right top image (1/3 width, top half) */}
    ...
    {/* Right bottom image (1/3 width, bottom half) */}
    <div className="col-span-2 row-span-1 rounded-lg overflow-hidden">
      <Image
    ...
    {/* Third row images: 6 equally spaced images */}
    {['banner4', 'banner5', 'banner6', 'banner7', 'banner8', 'banner9'].map((img, i) => (
      <div key={img} className="col-span-1 rounded-lg overflow-hidden">
        <Image
          src={`/assets/${img}.png`}
          alt={`Hotel image ${i + 4}`}
          width={200}
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Left side - Tabs and Property Details */}
        <div className="flex-1">
          {/* Navigation Tabs */}
          <div className="flex gap-6 mb-6 mr-8 border-b">
