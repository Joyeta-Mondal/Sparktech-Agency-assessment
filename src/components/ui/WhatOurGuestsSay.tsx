...
const WhatOurGuestsSay: React.FC = () => {
  ...
  const reviews: Review[] = [
    ...
    },
    {
      ...
      content:
        "The Executive Suite provided an exceptional experience. The room was endless equipped with everything you could need. The marble bathroom with its bathtub port luxury. The location is perfect for exploring the city, and the staff truly make you feel welcome and comfortable throughout your stay.",
      author: "Youssef R.",
      location: "Morocco",
      date: "15.10.2024",
      rating: 5,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="h-fit">
          <CardContent className="p-6">
            ...
            <div className="mb-4">{renderStars(reviews[currentReview].rating)}</div>
        ...
        {/* Next Review (Preview for lg only) */}
